...
int main()
{
	...
	Shader shader("shaderFile//VCommon.txt", "shaderFile//FCommon.txt");
	Shader skyboxShader("shaderFile//Vcubemap.txt", "shaderFile//Fcubemap.txt");
	...
	unsigned int cubeTexture = loadTexture("resource//texture//awesomeface.png");
